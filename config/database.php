    ...
    */
    ...
    'connections' => [
        ...
        'mysql_office'     => [
            'driver'         => 'mysql',
            'url'            => env('DB_URL'),
            'host'           => env('DB_OFFICE_HOST', '127.0.0.1'),
            'port'           => env('DB_OFFICE_PORT', '3306'),
            'database'       => env('DB_OFFICE_DATABASE', 'office'),
            'username'       => env('DB_OFFICE_USERNAME', 'root'),
            'password'       => env('DB_OFFICE_PASSWORD', ''),
        ...
        'mysql_backoffice' => [
            ...
            'database'       => env('DB_BACKOFFICE_DATABASE', 'office'),
        ...
        'mysql_app'        => [
            ...
            'database'       => env('DB_APP_DATABASE', 'office'),
